<?php /* Smarty version 2.6.31, created on 2020-05-03 05:12:06
	...
	<div id="footer">
		<div id="mainwrapper" style="text-align: center;">
			...
			<div id="footqversion" style="line-height: 20px;"><a style="color: #C1C1C1" href="https://sbpp.github.io/" target="_blank">SourceBans++</a> <?php echo $this->_tpl_vars['SB_VERSION']; ?>
<?php echo $this->_tpl_vars['SB_REV']; ?>
		    ...
		    <span style="line-height: 20px;"><?php echo $this->_tpl_vars['SB_QUOTE']; ?>
<span>
		</div>
	</div>
